  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        <button onClick={() => router.back()} className="p-2 rounded-xl hover:bg-white/5 transition-all">
              ...
              <div key={r.id} className="flex items-center gap-3 p-3 rounded-xl bg-white/5">
                ...
                <div className="flex gap-2">
                  <a href={r.url} target="_blank" rel="noopener noreferrer"
                    className="text-xs text-purple-400 hover:underline">View</a>
                  <button onClick={() => deleteReceiptMutation.mutate(r.id)}
