...
import { ArrowLeft, Edit3, Trash2, Calendar, CreditCard } from 'lucide-react';
      ...
      <div className="glass-card rounded-2xl p-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-purple-600/20 hover:bg-purple-600/30 text-purple-400 text-sm font-medium transition-all flex-1 justify-center"
          >
            <Edit3 className="w-4 h-4" />
            Edit
          </button>
          <button className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-400 text-sm font-medium transition-all flex-1 justify-center">
