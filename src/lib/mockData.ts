...
export const mockSubscriptions: Subscription[] = [
  {
    id: '1', name: 'Netflix', currentPlan: 'Standard 4K', amount: 15.99, currency: 'USD',
    billingPeriod: 'MONTHLY', category: 'STREAMING', status: 'ACTIVE',
    nextPaymentDate: new Date(Date.now() + 3 * 86400000).toISOString(),
    startDate: '2023-01-01', paymentCardId: '1', paymentCard: mockCards[0],
  },
  {
    id: '2', name: 'ChatGPT Plus', currentPlan: 'Pro', amount: 20, currency: 'USD',
    billingPeriod: 'MONTHLY', category: 'AI_SERVICES', status: 'ACTIVE',
    nextPaymentDate: new Date(Date.now() + 12 * 86400000).toISOString(),
    startDate: '2023-06-01', paymentCardId: '2', paymentCard: mockCards[1],
  },
  {
    id: '3', name: 'GitHub', currentPlan: 'Teams', amount: 4, currency: 'USD',
    billingPeriod: 'MONTHLY', category: 'INFRASTRUCTURE', status: 'ACTIVE',
    nextPaymentDate: new Date(Date.now() + 8 * 86400000).toISOString(),
    startDate: '2022-05-01', paymentCardId: '1', paymentCard: mockCards[0],
  },
  {
    id: '4', name: 'Spotify', currentPlan: 'Premium', amount: 9.99, currency: 'USD',
    billingPeriod: 'MONTHLY', category: 'MUSIC', status: 'ACTIVE',
    nextPaymentDate: new Date(Date.now() + 1 * 86400000).toISOString(),
    startDate: '2021-03-01', paymentCardId: '3', paymentCard: mockCards[2],
  },
  {
    id: '5', name: 'Vercel', currentPlan: 'Pro', amount: 20, currency: 'USD',
    billingPeriod: 'MONTHLY', category: 'INFRASTRUCTURE', status: 'ACTIVE',
    nextPaymentDate: new Date(Date.now() + 20 * 86400000).toISOString(),
    startDate: '2023-09-01', paymentCardId: '2', paymentCard: mockCards[1],
  },
  {
    id: '6', name: 'Adobe CC', currentPlan: 'All Apps', amount: 54.99, currency: 'USD',
    billingPeriod: 'MONTHLY', category: 'PRODUCTIVITY', status: 'PAUSED',
    nextPaymentDate: new Date(Date.now() + 30 * 86400000).toISOString(),
    startDate: '2020-01-01', paymentCardId: '1', paymentCard: mockCards[0],
  },
];
...
export const mockAnalytics: AnalyticsData = {
  ...
  byCategory: [
    ...
    { category: 'AI_SERVICES', amount: 20, count: 1 },
    { category: 'INFRASTRUCTURE', amount: 24, count: 2 },
